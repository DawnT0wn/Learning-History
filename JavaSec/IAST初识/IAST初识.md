...
![image-20230913175617090](images/1.png)
...
![image-20230906191859303](images/5.png)
...
![image-20230906193453017](images/6.png)
...
![image-20230906200027295](images/7.png)

![image-20230906200035913](images/8.png)
...
![image-20230907002954846](images/12.png)
...
![image-20230910170532538](images/16.png)

在handler中，发现只添加了一个enterSink方法

![image-20230910170549861](images/17.png)

![image-20230910172827133](images/18.png)

enterSink方法稍微有点不同，当触发这个方法的时候，会将当前线程的堆栈信息也保存下来，这个println打印的其实只是一个对象，堆栈信息具体打印在http的leaveHttp方法

![image-20230910173431040](images/19.png)
...
![image-20230910174552405](images/20.png)

IAST不会阻止命令执行，但是会根据上面的逻辑，当触发的时候会输出相应的路径等，以及调用栈

![image-20230910174905233](images/21.png)
...
![image-20230910175444053](images/22.png)
...
![image-20230910175744609](images/23.png)
...
![image-20230910175808682](images/24.png)
...
![image-20230913175243198](images/25.png)

简单实验了一下

![image-20230913175329898](images/26.png)

![image-20230913175355658](images/27.png)
